      ...
      <section>
        <div class="container-fluid">
          <div class="jumbotron text-center">
            <h3>Ingresar informacion solicitada de ciudad a ingresar</h3>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-2"><strong>Id ciudad:</strong> </div>
            <div class="col-lg-4">
              <input type="number" name="id" class="form-control" placeholder="Id Ciudad" required/>
            </div>
            <div class="col-lg-3">&nbsp;</div>
          </div>
          <div class="row">&nbsp;</div>
