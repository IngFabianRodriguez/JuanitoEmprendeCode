  ...
  <body>
    ...
    <div class="row-fluid">
        <nav class="text-center navbar navbar-inverse navbar-toggleable-md navbar-light bg-inverse">
          ...
          <a class="navbar-brand navbar-left" href="/indexciudad.php">JuanitoEmprende</a>
...
<section id=insertar>
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-2">
        <a href="../ciudad/crea_ciudad.php" class="btn btn-primary ">Crear Ciudad</a>
        </div>
      </div>
    </div>
  </div>
...
$sql='SELECT * FROM ciudad ORDER BY idciudad ASC';
