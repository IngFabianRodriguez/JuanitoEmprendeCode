        ...
        <div class="row">
              ...
              <div class="card">
                <img class="card-img-top" src="/img" alt="Card image cap" width="350" height="200">
                  <div class="card-block">
                      <h4 class="card-title">Creacion de Areas de la compañia</h4>
                      <div class="row">&nbsp;</div>
          ...
          <div class="col-lg-4">
              <div class="card">
                <img class="card-img-top" src="/img" alt="Card image cap" width="350" height="200">
                  <div class="card-block">
                      <h4 class="card-title">Consulta y otras operaciones.</h4>
                        <div class="row">&nbsp;</div>
                      <a href="consulta.php" class="btn btn-outline-primary my-2 my-sm-0">Consulta</a>
                  </div>
              </div>
          </div>
          <div class="col-lg-2">&nbsp;</div>
