      ...
      <section>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-2"><strong>Id proceso:</strong> </div>
            <div class="col-lg-4">
              <input type="number" name="id" class="form-control" placeholder="Id proceso" required/>
            </div>
            <div class="col-lg-3">&nbsp;</div>
          </div>
          <div class="row">&nbsp;</div>
          <div class="row">
            ...
            <div class="col-lg-4">
              <input type="text" name="nombre" class="form-control" placeholder="Nombre proceso" required/>
            </div>
            <div class="col-lg-3">&nbsp;</div>
          </div>
          <div class="row">&nbsp;</div>
          <div class="row">
            ...
            <div class="col-lg-4">
              <input type="number" name="Tb" class="form-control" placeholder="Tiempo basico" required/>
            </div>
            <div class="col-lg-3">&nbsp;</div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <input type="number" name="Tm" class="form-control" placeholder="Tiempo Maximo" required/>
            </div>
            <div class="col-lg-3">&nbsp;</div>
          </div>
          <div class="row">&nbsp;</div>
