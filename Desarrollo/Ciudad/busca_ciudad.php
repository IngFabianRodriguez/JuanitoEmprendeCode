  ...
  <body>
    ...
    <div class="row-fluid">
        <nav class="text-center navbar navbar-inverse navbar-toggleable-md navbar-light bg-inverse">
          ...
          <a class="navbar-brand navbar-left" href="index_ciudad.php">JuanitoEmprende</a>
...
?>
        <div class="jumbotron bg-success text-center">
          ...
          <p>A continuacion podras realizar las operaciones correspondientes a las ciudades</p>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 text-center">
        <h5>Para agregar alguna ciudad ir a el apartado de crear ciudad o seguir el siguiente boton</h5>
      </div>
      <div class="col-lg-2">
        <a href="crea_ciudad.php" class="btn btn-primary ">Crear Ciudad</a>
        </div>
      </div>
    </div>
  </div>
...
<section>
  ...
  <form class="navbar-form navbar-left" role="search" action="busca_ciudad.php">
...
$sql='SELECT * FROM ciudad WHERE Nombre_ciudad like "%'.$_GET['s'].'%"';
...
<tr>
	...
	<td>
<?php 
if ($_SESSION['cargo']=="Desarrollo" || $_SESSION['cargo']=="Coordinador" ) {
   ?>
